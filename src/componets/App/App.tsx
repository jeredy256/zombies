...
const App = () => {
  ...
  return (
    <div className={darkMode ? "dark-mode" : ""}>
      <header>
        <h1 className="pico">Local Downloads</h1>
      ...
      <div className="container">
        <div className="box">
          ...
          <h4>Bo1</h4>
          <a href="https://m-lyart.vercel.app/t5_dlcs.torrent">
            <h5>Full dlcs</h5>
          </a>
        </div>
        <div className="box">
          ...
          <h4>bo2</h4>
          <a href="https://m-lyart.vercel.app/t6_dlcs.torrent">
            <h5>Full dlcs</h5>
          </a>
        </div>
        <div className="box">
          ...
          <h4>bo3</h4>
          <a href="https://m-lyart.vercel.app/boiii.exe">
            <h5>Executavel do bo3</h5>
          </a>
          <a href="https://m-lyart.vercel.app/t7_full_game.torrent">
            <h5>Full dlcs</h5>
          </a>
        ...
        <div className="box">
          <a href="https://www.fosshub.com/qBittorrent.html">
            <img src={bit} alt="qbittorrent" />
            <h5>Download</h5>
          </a>
        </div>
      </div>
